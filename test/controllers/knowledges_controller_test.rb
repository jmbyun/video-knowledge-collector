...
class KnowledgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create knowledge" do
    assert_difference('Knowledge.count') do
      post knowledges_url, params: { knowledge: { body: @knowledge.body, knowledge_offer_id: @knowledge.knowledge_offer_id, user_id: @knowledge.user_id, video_id: @knowledge.video_id } }
    end
  ...
  test "should update knowledge" do
    patch knowledge_url(@knowledge), params: { knowledge: { body: @knowledge.body, knowledge_offer_id: @knowledge.knowledge_offer_id, user_id: @knowledge.user_id, video_id: @knowledge.video_id } }
